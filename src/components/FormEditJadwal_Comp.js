...
const FormEditJadwalComp = ({
    ...
    const patchUser = (data) => {
        const url = "http://localhost:3004/events/" + popSelectedIdJdwl.id;
        axios
            .patch(url, data)
            .then((res) => {
                setLastUpdate(new Date());
                setPopUpEdit(false);
                setPopSelectedIdJdwl(data);
            })
            .catch((err) => {
                console.log(err);
            });
    ...
    const handleSubmitFormEditJadwal = (event) => {
    ...
    return (
        <div className="p-8">
            <form onSubmit={(e) => handleSubmitFormEditJadwal(e)}>
                <div className="mb-8">
                ...
                <div className="mb-8">
                    <button
                        className="w-full bg-sky-400 rounded-md px-4 py-3 text-white flex justify-center items-center"
                        type="submit"
                    >
